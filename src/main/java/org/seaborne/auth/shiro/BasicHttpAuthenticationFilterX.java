...
public class BasicHttpAuthenticationFilterX extends AuthenticatingFilter {
    ...
    @Override
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedObject) {
        // Start of process.
        logx(log, "************ "+WebUtils.toHttp(request).getRequestURI()) ;
        logx(log, ">> isAccessAllowed") ;
        boolean b = super.isAccessAllowed(request, response, mappedObject) ;
        logx(log, "<< isAccessAllowed = "+b) ; 
        return b ;
    }
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        logx(log, ">> onAccessDenied") ;
        boolean b = onAccessDenied$(request, response) ;
        logx(log, "<< onAccessDenied = "+b) ; 
        return b ;
    }
    protected boolean onAccessDenied$(ServletRequest request, ServletResponse response) throws Exception {
    ...
    protected boolean isLoginAttempt(ServletRequest request, ServletResponse response) {
        logx(log, ">> isLoginAttempt") ;
        boolean b = isLoginAttempt$(request, response) ;
        logx(log, "<< isLoginAttempt = "+b) ;
        return b ;
    }
    ...
    protected final boolean isLoginRequest(ServletRequest request, ServletResponse response) {
        logx(log, ">> isLoginRequest") ;
        boolean b = isLoginRequest$(request, response) ;
        logx(log, "<< isLoginRequest = "+b) ;
        return b ;
    }
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) throws Exception {
        logx(log, ">> executeLogin") ;
        boolean b = super.executeLogin(request, response) ;
        logx(log, "<< executeLogin = "+b) ;
        return b;
    }
    ...
    protected String getAuthzHeader(ServletRequest request) {
        String s = getAuthzHeader$(request) ;
        logx(log, "Authorization: "+s) ;
        return s ;    
    }
    protected String getAuthzHeader$(ServletRequest request) {
    ...
    protected boolean isLoginAttempt(String authzHeader) {
        ...
        logx(log, "isLoginAttempt : "+authzScheme);
    ...
    protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
        ...
        logx(log, "createToken: "+username+" = "+password) ;
